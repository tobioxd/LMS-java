...
public class BSinglyLinkedList {
    ...
    public static void main(String[] args) {
        ...
        switch (caseNumber) {
            ...
            case 15:
                ...
                System.out.print("15. Merge two ordered singly linked lists of integers into one ordered list: " + listSize + "-node list = " + list.toString() + "; " + secondListSize + "-node list: " + secondList.toString());
            ...
            case 17:
                ...
                System.out.print("17. Attach a singly linked list of " + attachListSize + " elements " + attachList + " to the end of another singly linked list of " + listSize + " nodes: ");
                 list.traverse();
            ...
            case 24:
                System.out.print("24. Reverse the singly linked list of " + listSize + " nodes: " + list);
                list.reverse();
                list.traverse();
                break;
            ...
            case 25:
                ...
                System.out.println("25. Check whether two singly linked list have the same contents: 1st list of " + listSize + " elements: " + list + "; 2nd list of " + secondListSizeForComparison + " elements: " + secondListForComparison);
